...
MESSAGES: Final[dict[str, Entry]] = {
    ...
    "MAIN_PROGRESS_STEP": Entry("[{n}/{total}] {stage}", "[{n}/{total}] {stage}"),
    "MAIN_PROGRESS_TICK": Entry("{step}, {secs} s", "{step}, {secs} с"),
    "MAIN_PROGRESS_PYTHON": Entry("python", "python"),
    "MAIN_PROGRESS_VENV": Entry("venv", "venv"),
    "MAIN_PROGRESS_PIP": Entry("installing ansible-core", "установка ansible-core"),
    "MAIN_PROGRESS_GALAXY": Entry("galaxy collection", "коллекция galaxy"),
    "MAIN_PROGRESS_STAGING": Entry("staging dirs", "staging-каталоги"),
    "MAIN_PROGRESS_FILES": Entry("uploading repo", "загрузка репозитория"),
    "MAIN_PROGRESS_PLAYBOOK": Entry("playbook", "плейбук"),
